...
#[AsCommand(
    name: 'app:archive-monthly-statistics',
    description: 'Archive monthly statistics for all employees',
)]
class ArchiveMonthlyStatisticsCommand extends Command
{
    ...
    {
        $this->setDescription('Archives monthly statistics for all employees');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($employees as $employee) {
            // Calculate monthly revenue HT and TTC
        ...
        $io->success(sprintf('Archived monthly statistics for %d employees', count($employees)));
